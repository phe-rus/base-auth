...
> {
   ...
   * @example
   * ```ts title="issuer.ts"
   * import { DynamoStorage } from "@base-auth/core/storage/dynamo"
   *
   * issuer({
   ...
   * @example
   * ```ts title="issuer.ts"
   * import { THEME_SST } from "@base-auth/core/ui/theme"
   *
   * issuer({
   *   theme: THEME_SST
   *   // ...
   ...
   *
   * ```ts title="issuer.ts"
   * import type { Theme } from "@base-auth/core/ui/theme"
   *
   ...
   *
   * ```ts title="issuer.ts"
   * import { Select } from "@base-auth/core/ui/select"
   *
   * issuer({
   *   select: Select({
   *     providers: {
